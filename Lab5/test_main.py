...
def parse_args():
    ...
    parser.add_argument('--model_dir', default='./models/epoch79_acc0.6944444444444444_1.pt', help='directory for the best model')
...
def main():
    ...
    # Test the model
    print("test.json: ")
    test(args.n_z, test_cond, netG, evaluator, device, "test_results")
    print("new_test.json: ")
    test(args.n_z, new_test_cond, netG, evaluator, device, "new_test_results")
