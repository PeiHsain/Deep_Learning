...
def main():
    ...
    parser.add_argument('-m', '--model', default='td3_2.pth')
    parser.add_argument('--logdir', default='log/td3_2')
    # train
    ...
    parser.add_argument('--noise_clip', default=.3, type=float)
    parser.add_argument('--action_limit', default=1, type=float)
